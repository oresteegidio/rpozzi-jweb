...
public class RestClient {
	...
	private String truststore_path = "/Users/robertopozzi/git/bluemix/rpozzi-jweb-db/rpozzi-jweb/src/main/webapp/WEB-INF/security/secgateway-mac-endpoints/truststore/sg_trust.jks";
	private String truststore_password = "password";
	private String keystore_path = "/Users/robertopozzi/git/bluemix/rpozzi-jweb-db/rpozzi-jweb/src/main/webapp/WEB-INF/security/secgateway-mac-endpoints/RPozzi_Mac_WASLibertyCantieri_TLS/sg_key.p12";
	...
	private Client buildClient() {
		...
		if (isSSLEnabled) {
			try {
				...
				sslConfig.keyStoreFile(keystore_path);
				sslConfig.keyStorePassword(keystore_password);
				sslConfig.trustStoreType("JKS");
				sslConfig.trustStoreFile(truststore_path);
				sslConfig.trustStorePassword(truststore_password);
